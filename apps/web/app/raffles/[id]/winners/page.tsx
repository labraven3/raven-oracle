...
export default function WinnersPage() {
  ...
  return <main className="min-h-screen bg-[#07070a] text-zinc-100"><div className="mx-auto max-w-6xl px-5 py-10">
    ...
    <div className="mt-7 rounded-2xl border border-violet-400/15 bg-violet-500/5 p-6"><p className="text-[9px] font-black tracking-[.18em] text-violet-300">HOW NFT WINNERS WORK</p><p className="mt-3 text-sm leading-6 text-zinc-400">A selected winner stays the winner. Raven Oracle sends the verified profile Gmail as a notification, while the wallet address above is the address the project uses for its whitelist. There is no claim deadline, claim button, expiration, or automatic replacement.</p></div>
  </div></main>;
}
