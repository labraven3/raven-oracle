      ...
      <div className="mx-auto flex min-h-[60px] max-w-[1380px] items-center gap-3 px-4 sm:px-6 lg:px-10">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          {!authChecked ? null : isLoggedIn ? (
            <>
              <Link href="/dashboard/creator" className="rounded-lg border border-violet-500/30 bg-violet-500/10 px-3 py-2 text-[9px] font-black text-violet-200 hover:border-violet-400/60 hover:bg-violet-500/20 sm:px-4 sm:text-[10px]">Dashboard</Link>
